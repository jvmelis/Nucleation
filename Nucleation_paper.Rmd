...
# After first submission
  ...
  * Considering only small recruits in species richness analyses item ([I.D](#d-species-richness-of-recruits))
...
prop_regenerant_full <- species_table |>
  ...
  dplyr::summarise(
    n_species = dplyr::n(),
    n_ind = sum(n_total),
    n_planted_trees = sum(ifelse(planted_tree == "Yes", n_sapling, 0), na.rm = TRUE),
    n_planted_spp = sum(planted_tree == "Yes"), 
    n_biotic_trees  = sum(ifelse(biotic_fruit == "Yes", n_sapling, 0), na.rm = TRUE),
...
prop_regenerant_full |>
  ...
  dplyr::select(Treatment,Planted, prop_planted_text, prop_planted_spp_text) |>
  tidyr::pivot_wider(
    names_from = Treatment,
    values_from = c(prop_planted_text, prop_planted_spp_text)
